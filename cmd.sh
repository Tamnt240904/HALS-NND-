...
python scripts/visualize_features.py --model resnet50 --layer layer3 --csae_model output/weights/original/resnet50_layer3_csae_masked_loss_model.pkl --mode finetuned --num_images 10
...
# python scripts/check_accuracy.py --all --num_samples 1500 --mode finetuned # change mode here ['both', 'original', 'finetuned', 'smart']
